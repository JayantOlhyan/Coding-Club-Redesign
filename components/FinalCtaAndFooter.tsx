...
export function FinalCtaAndFooter() {
  ...
  return (
    <footer
      ...
      className="w-full bg-[var(--ink-surface)] pt-16 md:pt-24 pb-12"
    >
      <div className="max-w-[620px] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Lead Capture Form Card: Centered on dark */}
        <div className="w-full bg-[#1e2129] border border-[#2e3340] rounded p-6 sm:p-8 md:p-10 shadow-lg mb-12">
          {isSuccess ? (
            <div className="py-8 text-center">
              ...
              <p className="text-lg font-semibold text-[var(--ink-on-dark)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-4 py-3 rounded border border-[#3b4050] bg-[#16181d] text-[var(--ink-on-dark)] placeholder:text-[#9ca3af] focus:outline-none focus:ring-2 focus:ring-[var(--accent)] text-base"
                />
              </div>
          ...
          <div className="text-center mt-6 pt-6 border-t border-[#2e3340]">
            <a
              href={l389.href}
              target="_blank"
              rel="noopener noreferrer"
              data-block={SECTION_MAP.finalCtaAndFooter.links[4]}
              className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] px-6 py-3 rounded bg-[#2a2e39] hover:bg-[#343946] text-[var(--ink-on-dark)] font-semibold text-sm md:text-base transition-colors border border-[#3b4050] focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
            >
              {l389.text}
            </a>
          </div>
        ...
        <div className="pt-8 border-t border-[#2e3340] flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center p-1.5 rounded bg-white/95">
            <img
              src={footerLogoSrc}
          ...
          <nav className="flex flex-wrap items-center justify-center sm:justify-end gap-6 text-sm text-[#9ca3af]">
            <a
              href={l385.href}
              target="_blank"
              rel="noopener noreferrer"
              data-block={SECTION_MAP.finalCtaAndFooter.links[0]}
              className="hover:text-[var(--ink-on-dark)] transition-colors py-2"
            >
              {l385.text}
            </a>
            <a
